    ...
    constructor(object, domElement) {
        ...
        this.mousemove = function (event) {
            ...
            if (!this.dragToLook || this.mouseStatus > 0) {
                ...
                this.object.rotateX(event.movementY * -0.001)
                this.object.rotateY(event.movementX * -0.001)
        ...
        this.update = function (delta) {
            ...
            scope.object.translateX(scope.moveVector.x * 20);
            scope.object.translateY(scope.moveVector.y * 20);
            scope.object.translateZ(scope.moveVector.z * 20);
